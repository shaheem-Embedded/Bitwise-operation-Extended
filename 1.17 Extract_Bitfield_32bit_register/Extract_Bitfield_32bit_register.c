...
int Extract_bits(int reg,int start,int length);
...
d2b32(reg);
printf("\nEnter the start position to Extract the bits:\n");
scanf("%d",&start);
printf("\nEnter the Length to Extract the bits:\n");
scanf("%d",&length);

int result = Extract_bits(reg,start,length);
